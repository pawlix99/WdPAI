        ...
        <section class="news">
            <div id="center">
                <div id="headline">
                    ...
                    <div class="the_content"> <img src="public/uploads/headline.jpg"/>
                ...
                <div class="featured-popular">
                    <div id="featured">
                        ...
                        <div class="spost">
                            ...
                            <img src="public/uploads/featured1.jpg"/>
                        ...
                        <div class="spost">
                            ...
                            <img src="public/uploads/featured2.jpg"/>
                        ...
                        <div class="spost">
                            ...
                            <img src="public/uploads/featured3.jpg"/>
                    ...
                    <div id="popular">
                        ...
                        <div class="spost">
                            ...
                            <img src="public/uploads/popular1.JPG"/>
                        ...
                        <div class="spost">
                            ...
                            <img src="public/uploads/popular2.JPG"/>
                        ...
                        <div class="spost">
                            ...
                            <img src="public/uploads/popular3.JPG"/>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sit amet odio ullamcorper odio aliquam porta vel &#8230; <a href="#">Read more &raquo;</a></p>
                        </div>
                        <div class="spbottom"></div>
                    </div>
                ...
                <div id="latest">
                    ...
                    <div class="spost">
                        ...
                        <img src="public/uploads/latest1.jpeg" />
                    ...
                    <div class="spost">
                        ...
                        <img src="public/uploads/latest2.jpg" />
                    ...
                    <div class="spost">
                        ...
                        <img src="public/uploads/latest3.jpg" />
